...
def status_list(open_signals: list[dict], targets_by_signal: dict) -> str:
    lines = [f"📋 <b>POSISI DIPANTAU</b> ({len(open_signals)})", DIVIDER]
    for s in open_signals:
        ...
        lines.append(
            f"\n{status_icon}  {pair_title(s['pair'], s['direction'])}\n"
